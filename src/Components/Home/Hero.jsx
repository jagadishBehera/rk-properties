  ...
  return (
    <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-32">
        ...
        {/* Bottom quick links — FIX: replaced href="#" with real paths using React Router Link */}
        <div className="mt-16 border-t border-white/10 pt-8">
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-gray-400 lg:justify-between">
            ...
            <Link to="/properties?type=house" className="hover:text-white transition">Houses</Link>
            <Link to="/properties?type=apartment" className="hover:text-white transition">Apartments</Link>
            <Link to="/properties?type=condo" className="hover:text-white transition">Condos</Link>
            <Link to="/properties?type=townhome" className="hover:text-white transition">Townhomes</Link>
            <Link to="/properties?type=land" className="hover:text-white transition">Lots & land</Link>
            <Link to="/properties?type=commercial" className="hover:text-white transition">Commercial</Link>
          </div>
        </div>
      </div>
    </div>
