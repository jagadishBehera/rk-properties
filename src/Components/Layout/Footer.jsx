...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-300">
      ...
      <AnimatePresence>
        {showBackToTop && (
          <motion.button
            ...
            whileHover="hover"
            whileTap="tap"
            className="fixed bottom-8 right-8 p-4 bg-blue-600 text-white rounded-full shadow-lg z-50 group"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-2 space-y-6">
            ...
            <motion.p
              ...
              className="text-base leading-relaxed text-gray-500 dark:text-gray-400 max-w-md"
            >
            ...
            <div className="space-y-4">
              {contactInfo.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div className="p-2 bg-blue-50 dark:bg-blue-900/30 rounded-lg group-hover:bg-blue-100 dark:group-hover:bg-blue-800/40 transition-colors duration-300">
          ...
          {Object.entries(footerLinks).map(([category, links], categoryIndex) => (
            ...
            >
              <motion.h3
                whileHover={{ x: 5 }}
                className="text-gray-900 dark:text-white font-semibold text-lg capitalize relative inline-block"
              >
                {category}
                <motion.span
                ...
                {links.map((link, index) => {
                  ...
                  return (
                    ...
                    >
                      <a
                        href={link.href}
                        className="text-sm text-gray-500 dark:text-gray-400 flex items-center space-x-2 group"
                      >
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              ...
              >
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 transition-all duration-300 pr-24"
                />
                <motion.button
                  type="submit"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="absolute right-1 top-1 px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 transition-colors duration-300 flex items-center space-x-2"
                >
                  <motion.span
                    animate={{ x: [0, 3, 0] }}
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <motion.div
              whileHover={{ scale: 1.05 }}
              className="text-sm text-gray-500 dark:text-gray-500 flex items-center space-x-2"
            >
